const researchProjects = [
  {
    _id: "1",
    title:
      "Vendor Managed Inventory (VMI) Implementation for Volvo Construction Equipment",
    works: [
      {
        subTitle: "Project Context and Challenge",
        description:
          "During my tenure as Key Account Manager – Enterprise Sales at Moglix, I led a strategic project to implement a Vendor Managed Inventory (VMI) system for Maintenance, Repair, and Operations (MRO) consumables at the Volvo Construction Equipment manufacturing plant in Bangalore, India. <br/><br/> The client faced operational inefficiencies in managing their MRO procurement process. The existing system involved multiple suppliers, manual ordering processes, and fragmented inventory management, which often resulted in procurement delays, inconsistent stock availability, and higher operational costs. As a strategic supplier partner, Moglix aimed to address these issues by introducing a more efficient and technology-enabled inventory management solution.",
      },
      {
